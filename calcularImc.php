...
<body>
    ...
    <div class="menu-principal">
        <table>
            <thead>
                <tr>
                    <th>NOME</th><th>CPF</th><th>CÁLCULO</th><th>MATRÍCULA</th><th>TREINADOR</th>
                </tr>
            </thead>
            ...
            <?php
                ...
                foreach ($clientes as $cliente) {
                    ...
                    echo "<tr><td>{$umCliente->recuperaNome()}</td> <td>{$umCliente->recuperaCpf()}</td> <td>{$imcCliente->recuperaImc()}</td> <td>{$umCliente->recuperaMatricula()}</td> <td>{$umCliente->recuperaTreinador()}</td></tr>";
                }
