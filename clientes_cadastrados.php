...
<body>
    ...
    <div class="menu-principal">
        <table>
            <thead>
                <tr>
                    <th>NOME</th><th>CPF</th><th>PESO</th><th>ALTURA</th><th>TREINADOR</th>
                </tr>
            </thead>
            ...
            <?php
                ...
                foreach ($clientes as $cliente) {
                    ...
                    echo "<tr><td>{$umCliente->recuperaNome()}</td> <td>{$umCliente->recuperaCpf()}</td> <td>{$umCliente->recuperaPeso()}</td> <td>{$umCliente->recuperaAltura()}</td> <td>{$umCliente->recuperaTreinador()}</td></tr>";
                }
        ...
        <form action="/imc.php" method = 'post'><input type="submit" value="IMC" name="imc" class="botao"></form>
